---
name: g1-slide-deck-guide
description: "Use when creating, reviewing, or revising a Carleton University Technology Innovation Management (TIM) Gate 1 slide deck - provides slide structure, content expectations, formatting guidance, and the six official G1 guidelines."
---

# TIM Gate 1 (G1) Slide Deck Guide
...
1. `Guidelines/G1 Slide Deck/Guide for G1 Slide Decks.txt` - 6 official guidelines + G1 objectives
2. `Guidelines/G1 Slide Deck/TIM_gate1_project_template_2025_Feb 14.ppt` - official template
3. `Guidelines/G1 Slide Deck/BRECK AGYEKUM. G1 deck.Aug 26.pdf` - example (MEng, AI Logistics, 32 pages)
4. `Guidelines/G1 Slide Deck/Veronica Ihem G1 deck Aug 26.pdf` - example (MDTE, Agrifood Trade, 36 pages)
...
- Favor succinct text over lengthy descriptions

### Guideline 6: Align Deliverables (Slide 2) with Results (After Slide 8)
...
- **Left:** Author's email address (italic, e.g., `onwonaagyekum@cmail.carleton.ca` or `veronicaamadiihem@gmail.com`)
...
### Footer Numbering Notes
- Footer slide numbers should increment sequentially (Slide 1, Slide 2, Slide 3...)
...
| Rule | Details |
|------|---------|
| **Gap-to-Deliverable mapping** | Each "Not Known" item on Slide 4 must explicitly reference which deliverable(s) address it |
| **Deliverable-to-Results alignment** | Deliverables listed on Slide 2 must directly match the results presented after Slide 8 |
| **Not Known to Literature Review** | Unknown aspects on Slide 4 should be addressed by findings from the Literature Review (Slide 5) |
| **Literature Review to Deliverables** | Literature review streams should inform and support the deliverables |
| **Method produces Deliverables** | The research method steps (Slide 6) must produce the deliverables listed on Slide 2 |
| **13-week feasibility** | The objective and all deliverables must be achievable within 13 weeks |
| **SMART objective** | The objective on Slide 2 must be Specific, Measurable, Achievable, Relevant, and Time-bound |
| **Consistency across slides** | Client name, deliverable names, and terminology must be consistent throughout |
...
1. Be phrased as a question or knowledge gap
2. Include a parenthetical reference to the deliverable(s) that address it
3. Connect logically to one or more literature review streams on Slide 5
